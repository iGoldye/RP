...
--
-- Хост: localhost:3306
-- Время создания: Июл 27 2019 г., 20:59
-- Версия сервера: 10.4.6-MariaDB-1:10.4.6+maria~stretch
...
--
-- База данных: `zap433805-1`
--

-- --------------------------------------------------------

--
-- Структура таблицы `addon_account`
--
...
--
-- Дамп данных таблицы `addon_account`
--
...
--
-- Структура таблицы `addon_account_data`
--
...
--
-- Дамп данных таблицы `addon_account_data`
--
...
--
-- Структура таблицы `addon_inventory`
--
...
--
-- Дамп данных таблицы `addon_inventory`
--
...
--
-- Структура таблицы `addon_inventory_items`
--
...
--
-- Структура таблицы `cardealer_vehicles`
--
...
--
-- Структура таблицы `datastore_data`
--
...
--
-- Дамп данных таблицы `datastore_data`
--
...
--
-- Дамп данных таблицы `fine_types`
--
...
--
-- Дамп данных таблицы `job_grades`
--
...
(18, 'police', 0, 'recruit', 'Recruit', 20, '{}', '{}'),
...
--
-- Структура таблицы `owned_properties`
--
...
--
-- Структура таблицы `owned_vehicles`
--
...
--
-- Структура таблицы `rented_vehicles`
--
...
--
-- Структура таблицы `society_moneywash`
--
...
--
-- Структура таблицы `user_licenses`
--
...
--
-- Структура таблицы `user_parkings`
--
...
--
-- Структура таблицы `vehicle_categories`
--
...
--
-- Структура таблицы `vehicle_sold`
--
...
--
-- Индексы таблицы `addon_account`
--
ALTER TABLE `addon_account`
  ADD PRIMARY KEY (`name`);

--
-- Индексы таблицы `addon_account_data`
--
...
--
-- Индексы таблицы `addon_inventory`
--
ALTER TABLE `addon_inventory`
  ADD PRIMARY KEY (`name`);

--
-- Индексы таблицы `addon_inventory_items`
--
...
--
-- Индексы таблицы `cardealer_vehicles`
--
...
--
-- Индексы таблицы `datastore`
--
ALTER TABLE `datastore`
  ADD PRIMARY KEY (`name`);

--
-- Индексы таблицы `datastore_data`
--
...
--
-- Индексы таблицы `owned_properties`
--
ALTER TABLE `owned_properties`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `owned_vehicles`
--
...
--
-- Индексы таблицы `rented_vehicles`
--
...
--
-- Индексы таблицы `society_moneywash`
--
...
--
-- Индексы таблицы `user_licenses`
--
ALTER TABLE `user_licenses`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `user_parkings`
--
...
--
-- Индексы таблицы `vehicle_sold`
--
ALTER TABLE `vehicle_sold`
  ADD PRIMARY KEY (`plate`);

--
-- Индексы таблицы `weashops`
--
...
--
-- AUTO_INCREMENT для таблицы `addon_account_data`
--
ALTER TABLE `addon_account_data`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT для таблицы `addon_inventory_items`
--
ALTER TABLE `addon_inventory_items`
...
ALTER TABLE `billing`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `cardealer_vehicles`
--
ALTER TABLE `cardealer_vehicles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT для таблицы `datastore_data`
--
ALTER TABLE `datastore_data`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT для таблицы `fine_types`
--
ALTER TABLE `fine_types`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
--
-- AUTO_INCREMENT для таблицы `job_grades`
--
ALTER TABLE `job_grades`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT для таблицы `owned_properties`
--
ALTER TABLE `owned_properties`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `owned_vehicles`
--
ALTER TABLE `owned_vehicles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT для таблицы `society_moneywash`
--
ALTER TABLE `society_moneywash`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `user_contacts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `user_inventory`
--
ALTER TABLE `user_inventory`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT для таблицы `user_licenses`
--
ALTER TABLE `user_licenses`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `user_parkings`
--
ALTER TABLE `user_parkings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `weashops`
--
ALTER TABLE `weashops`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
