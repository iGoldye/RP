const Dashcam = new Vue({
    ...
    data: {
        ...
        dashMessageOne: "Лицензированный транспорт",
        dashLabel: "Штата San Andreas",
        dashMessageTwo: "Любое неавторизированное использование попадает под статью 13 S.A. Pen. Code 502(a)."
    },
