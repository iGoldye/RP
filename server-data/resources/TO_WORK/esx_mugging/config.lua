...
Config.MaxMoney = 30               --  Max amount of money received from mugging.
...
Config.AddItemsMax = 2              --  This is the max number of items you can receive from NPC from mugging - min is 1

Config.PoliceNotify = 70            --  This is percent the police will get notified: example: 40 means 40% chance of notification.
