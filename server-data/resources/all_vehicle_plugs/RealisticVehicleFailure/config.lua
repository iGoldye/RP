...
cfg = {
	...
	randomTireBurstInterval = 3600,				-- Number of minutes (statistically, not precisely) to drive above 22 mph before you get a tire puncture. 0=feature is disabled
...
repairCfg = {
	...
	fixMessages = {
		"Вы воткнули пробку от масла обратно",
		"Вы остановили утечку масла - жевательной резинкой",
		"Вы отремонтировали масляную трубку с помощью изоленты",
		"Вы затянули винт масляного поддона и остановили течь",
		"Вы пнули двигатель, и он волшебным образом ожил",
		"Вы удалили ржавчину с свечи зажигания",
		"Вы закричали на свой автомобиль, и это как-то дало эффект"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Вы проверили мяслянную заглушку. Она на всё ещё на месте",
		"Вы посмотрели на двигатель - он выглядит нормально",
		"Вы убедились в том, что изолента всё ещё держит двигатель в одном целом",
		"Вы прибавили громкости на радио. Это просто приглушило странные звуки из двигателя",
		"Вы добавили средство против ржавчины в свечу зажигания. Ничего не изменилось",
		"Никогда не ремонтируй то, что не сломано - говорили они. Вы не послушали. В любом случае, хуже не стало"
	},
	noFixMessageCount = 6
}
