Locales['en'] = {
  ...
  ['garage_buyitem'] = 'Приобрести служебный автомобиль',
  ['shop_item'] = '$%s',
  ['vehicleshop_title'] = 'Приобрести служебный автомобиль',
  ['vehicleshop_confirm'] = 'Вы хотите купить служебный автомобиль?',
  ['vehicleshop_bought'] = 'Вы купили ~y~%s~s~ за ~r~$%s~s~',
  ['vehicleshop_money'] = 'Вы не можете позволить себе служебный автомобиль',
