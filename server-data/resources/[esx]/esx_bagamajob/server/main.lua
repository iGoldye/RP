...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'bagama', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'bagama', _U('bagama_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'bagama', 'bagama', 'society_bagama', 'society_bagama', 'society_bagama', {type = 'private'})



RegisterServerEvent('esx_bagamajob:getStockItem')
AddEventHandler('esx_bagamajob:getStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_bagama', function(inventory)
...
ESX.RegisterServerCallback('esx_bagamajob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_bagamajob:putStockItems')
AddEventHandler('esx_bagamajob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_bagamajob:getFridgeStockItem')
AddEventHandler('esx_bagamajob:getFridgeStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_bagama_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_bagamajob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_bagamajob:putFridgeStockItems')
AddEventHandler('esx_bagamajob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_bagamajob:buyItem')
AddEventHandler('esx_bagamajob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_bagama', function(account)
...
RegisterServerEvent('esx_bagamajob:craftingCoktails')
AddEventHandler('esx_bagamajob:craftingCoktails', function(itemValue)
    ...
    if _itemValue == 'teqpaf' then
        SetTimeout(10000, function()
            ...
            local alephQuantity     = xPlayer.getInventoryItem('limonade').count
            local bethQuantity      = xPlayer.getInventoryItem('bagama').count

            if alephQuantity < 2 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') .. _U('limonade') .. '~w~')
            elseif bethQuantity < 2 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') .. _U('bagama') .. '~w~')
            else
                local chanceToMiss = math.random(100)
                if chanceToMiss <= Config.MissCraft then
                    TriggerClientEvent('esx:showNotification', _source, _U('craft_miss'))
                    xPlayer.removeInventoryItem('limonade', 2)
                    xPlayer.removeInventoryItem('bagama', 2)
                else
    ...
    if _itemValue == 'metreshooter' then
        SetTimeout(10000, function()
            ...
            local daletQuantity     = xPlayer.getInventoryItem('bagama').count
    ...
    if _itemValue == 'jagercerbere' then
        SetTimeout(10000, function()
            ...
            local bethQuantity      = xPlayer.getInventoryItem('vodka').count
            local gimelQuantity     = xPlayer.getInventoryItem('bagama').count
...
ESX.RegisterServerCallback('esx_bagamajob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_bagama', function(store)
...
ESX.RegisterServerCallback('esx_bagamajob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_bagamajob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_bagamajob:getPlayerInventory', function(source, cb)
