	...
	for k,v in pairs(Config.Menus) do
		...
		if data.value == k then
			...
			if v.modType ~= nil then
				...
				elseif v.modType == 'color1' or v.modType == 'color2' or v.modType == 'pearlescentColor' or v.modType == 'dashboardColor' or v.modType == 'wheelColor' then
				...
				elseif v.modType == 'color1' or v.modType == 'color2' or v.modType == 'pearlescentColor' or v.modType == 'dashboardColor' or v.modType == 'wheelColor' then -- RESPRAYS
				...
				if data.value == 'primaryRespray' or data.value == 'secondaryRespray' or data.value == 'pearlescentRespray' or data.value == 'dashboardRespray' or data.value == 'modFrontWheelsColor' then
