...
--			if xPlayer == nil then
--				xPlayer = xPlayers[math.random(1,#xPlayers)]
--			end
...
--				print("Pos changed: "..plate)
				...
				local pos = { ["x"] = math.floor(car.coords.x), ["y"] = math.floor(car.coords.y), ["z"] = math.floor(car.coords.z), ["r"] = math.floor(car.heading)}
