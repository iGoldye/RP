...
Config.Animations = {
...

	{
		...
		items = {
			...
			{label = "Пританцовывая 1", type = "attitude", data = {lib = "move_m@money", anim = "move_m@money"}},
	  	{label = "Пританцовывая 2", type = "attitude", data = {lib = "move_m@money", anim = "move_m@money"}},
...

	{
		...
		items = {
			...
			{label = "Спешащая Ж", type = "attitude", data = {lib = "move_f@hurry@a", anim = "move_f@hurry@a"}},
