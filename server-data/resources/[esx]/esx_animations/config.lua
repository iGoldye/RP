...
Config.Animations = {
...

	{
		...
		items = {
			...
			{label = "Менять покрышку", type = "dpemotes", data = {anim = "mechanic3"}},
			...
			{label = "Листодув", type = "dpemotes", data = {anim = "leafblower"}},
...

	{
		...
		items = {
		  ...
		  {label = "Неа!", type = "anim", data = {lib = "mini@prostitutestalk", anim = "street_argue_f_a", flag = 9}},
			...
			{label = "Клоун2", type = "dpemotes", data = {anim = "clownd2"}},
			{label = "Угроза", type = "dpemotes", data = {anim = "cuttroat"}},
	...
	},
	{
      ...
      -- {label = "Сидеть тест", type = "scenario", data = {anim = "WORLD_HUMAN_SEAT_LEDGE"}},
			...
			{label = "Ужас", type = "dpemotes", data = {anim = "sitscared"}},
		}
	},
