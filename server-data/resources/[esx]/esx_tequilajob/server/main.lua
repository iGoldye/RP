...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'tequila', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'tequila', _U('tequila_customer'), true, true)
...
RegisterServerEvent('esx_tequilajob:getFridgeStockItem')
AddEventHandler('esx_tequilajob:getFridgeStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_tequila_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_tequilajob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_tequilajob:putFridgeStockItems')
AddEventHandler('esx_tequilajob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_tequilajob:buyItem')
AddEventHandler('esx_tequilajob:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_tequilajob:craftingCoktails')
AddEventHandler('esx_tequilajob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_tequilajob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_tequila', function(store)
...
ESX.RegisterServerCallback('esx_tequilajob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_tequilajob:removeVaultWeapon', function(source, cb, weaponName)
