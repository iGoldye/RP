Locales['en'] = {
	...
	['robbery_has_cancelled'] = '~r~ Взлом прекратиться: ~b~',
	['already_robbed'] = 'Этот магазин уже был ограблен, Ждите: ',
	['seconds'] = 'Секунд.',
	['rob_in_prog'] = '~r~ Взлом в процессе: ~b~',
	['started_to_rob'] = 'Вы начали взлом ',
	['do_not_move'] = ', Не двигайтесь!',
	['alarm_triggered'] = 'Сработала сигнализация',
	['hold_pos'] = 'Ожидайте!',
	['robbery_complete'] = '~r~ Успешный взлом!.~s~ ~h~  ',
