...
Config.RefillCost = 10 -- If it is missing half of it capacity, this amount will be divided in half, and so on.
...
Config.Strings = {
	ExitVehicle = "Выйдите из машины для заправки",
	EToRefuel = "Нажмите ~g~E ~w~для заправки",
	JerryCanEmpty = "Канистра пуста",
	FullTank = "Бензобак полон",
	PurchaseJerryCan = "Нажмите ~g~E ~w~для покупки канистры за $~g~" .. Config.JerryCanCost,
	CancelFuelingPump = "Нажмите ~g~E ~w~для отмены заправки",
	CancelFuelingJerryCan = "Press ~g~E ~w~для отмены заправки",
	NotEnoughCash = "Недостаточно средств",
	RefillJerryCan = "Нажмите ~g~E ~w~ чтобы пополнить канистру за $~g~",
	NotEnoughCashJerryCan = "Не хватает средств чтобы заполнить канистру",
